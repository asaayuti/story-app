...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.getStories("token test")).thenReturn(expectedStory)

        val mainViewModel = MainViewModel(storyRepository)
        val actualStory: PagingData<StoryItem> = mainViewModel.getStories("token test").getOrAwaitValue()
